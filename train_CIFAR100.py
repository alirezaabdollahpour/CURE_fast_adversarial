...
def get_args():
    ...
    parser.add_argument('--out-dir', default='CIFAR100_Models', type=str, help='Output directory')
...
def main():
    ...
    results_csv = f'CIFAR100_h_{args.h}_betta_{args.betta}_lambda_{args.lambda_}_epochs_{args.epochs}_lr_{args.lr_max}_lr_schedule_{args.lr_schedule}_{args.delta}_loss_clean_g3_direction_{args.attack}_epsilon_{args.epsilon}_FGSM_alpha_{args.fgsm_alpha}.csv'
