...
def main():
    ...
    results_csv = f'train_FGSM_h_{args.h}_betta_{args.betta}_lambda_{args.lambda_}_epochs_{args.epochs}_lr_{args.lr_max}_lr_schedule_{args.lr_schedule}_{args.delta}_loss_clean_g2_direction_{args.attack}_{args.epsilon}.csv'
    ...
    for epoch in range(args.epochs):
        ...
        for i, (X, y) in tqdm(enumerate(train_loader)):
            ...
            if args.attack == 'fgsm':
                ...
                delta = zero_grad(model, X, y, epsilon, args.fgsm_alpha * epsilon, args.zero_qval, args.zero_iters, fgsm_init=args.delta_init)
