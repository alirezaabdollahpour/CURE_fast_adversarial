...
def get_args():
    ...
    parser.add_argument('--h', default=2.0, type=float, help='hyperparameter for CURE regulizer')
    parser.add_argument('--lambda_', default=4.0, type=float, help='weight for CURE regulizer')
    parser.add_argument('--data-dir', default='cifar-data', type=str)
    parser.add_argument('--epochs', default=100, type=int)
    parser.add_argument('--lr-schedule', default='cyclic', choices=['cyclic', 'multistep'])
    parser.add_argument('--lr-min', default=0.5, type=float)
